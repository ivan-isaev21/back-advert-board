...
class MyAdvertTest extends TestCase
{
    private $myAdvertsUrl = '/api/v1/adverts/me/';
    private $user;
    private $anotherUser;
    private $token;
    private $headers = [];
    ...
    {
        $response = $this->getJson($this->myAdvertsUrl, $this->headers);
    ...
    {
        $payload = [];
        $createUrl = $this->myAdvertsUrl . $this->category->id;
